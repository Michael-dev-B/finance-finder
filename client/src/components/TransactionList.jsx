    ...
    <>
      ...
      <div className="mb-3 flex flex-wrap items-center gap-2">
        <input
          ...
          className="rounded border border-border bg-surface px-3 py-1.5 text-sm text-ink placeholder:text-muted focus:border-accent focus:outline-none"
        />
        <select
          value={filter.type}
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-border bg-surface">
              {visible.map((t) => {
                ...
                return (
                  <tr key={t.id} className={`hover:bg-bg${t.is_reviewed ? ' opacity-60' : ''}`}>
